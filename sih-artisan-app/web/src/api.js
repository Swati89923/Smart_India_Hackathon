/**
 * API client for the ShilpSaathi Express backend (../backend, port 4000).
 *
 ...
 * copy of the seed data — same behaviour as mobile/src/api.js.
...
const local = {
  artisans: structuredClone(SAMPLE_ARTISANS),
  buyers: structuredClone(SAMPLE_BUYERS),
  products: structuredClone(SAMPLE_PRODUCTS),
  enquiries: structuredClone(SAMPLE_ENQUIRIES),
...
export const getSettings = () => call("GET", "/admin/settings", null, () => structuredClone(local.settings));
